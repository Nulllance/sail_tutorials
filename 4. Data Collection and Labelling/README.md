...
5. Once all the annotations are completed, save the annotation using Annotation -> Export Annotations option in the required format. The exported annotations can be reloaded using Annotation -> Import Annotations option according to the format originally saved.
